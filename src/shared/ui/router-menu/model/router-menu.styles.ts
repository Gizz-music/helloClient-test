//Перенесены Tailwind-классы RouterMenu

export const menuNavClassName = [
...
export const menuContainerClassName = [
...
export const groupInnerWrapperClassName = [
